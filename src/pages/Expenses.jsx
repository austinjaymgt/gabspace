...
<div style={{ padding: '16px 20px', backgroundColor: t.colors.successLight, borderRadius: t.radius.md, border: `1px solid ${t.colors.success}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <a href={selectedExpense.receipt_url} target="_blank" rel="noreferrer" style={{ padding: '7px 14px', borderRadius: t.radius.md, border: `1px solid ${t.colors.primary}`, backgroundColor: t.colors.bgCard, color: t.colors.primary, fontSize: t.fontSizes.sm, fontWeight: '600', textDecoration: 'none' }}>
              View receipt
            </a>
          </div>
        ) : (
...
<a href={editingExpense.receipt_url} target="_blank" rel="noreferrer" style={{ fontSize: t.fontSizes.sm, color: t.colors.primary, textDecoration: 'none', fontWeight: '500' }}>View current receipt</a>
...
const styles = {
  ...
  tableHeader: { display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 0.3fr', padding: '12px 20px', backgroundColor: t.colors.bg, borderBottom: `1px solid ${t.colors.border}`, fontSize: t.fontSizes.xs, fontWeight: '600', color: t.colors.textTertiary, textTransform: 'uppercase', letterSpacing: '0.08em' },
  tableRow: { display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 0.3fr', padding: '14px 20px', borderBottom: `1px solid ${t.colors.borderLight}`, alignItems: 'center' },
