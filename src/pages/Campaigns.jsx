    ...
    <div style={styles.page}>
      ...
      <div style={styles.summaryRow}>
        ...
        <div style={styles.summaryCard}>
          ...
          <div style={{ ...styles.summaryValue, color: '#cc7700' }}>
        ...
        <div style={styles.formCard}>
          ...
          <div style={styles.formGrid}>
            ...
            <div style={styles.field}>
              ...
              <input
                style={styles.input}
                placeholder="e.g. 10 new leads, 500 reach"
                value={form.goal}
            ...
            <div style={{ ...styles.field, gridColumn: 'span 2' }}>
              ...
              <input
                style={styles.input}
                placeholder="What were the outcomes? (fill in after campaign ends)"
                value={form.results}
          ...
          {campaigns.map(campaign => {
            ...
            return (
              ...
              >
                ...
                {campaign.projects && (
                  <div style={styles.campaignProject}>
