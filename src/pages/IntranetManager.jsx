...
export default function IntranetManager({ businessSpaceId, userRole }) {
  ...
  const s = {
    ...
    tabs: { display: 'flex', gap: '4px', marginBottom: '24px', background: t.colors.bgCard, borderRadius: t.radius.full, padding: '4px', border: `0.5px solid ${t.colors.border}`, width: 'fit-content' },
    tab: (active) => ({ fontSize: '12px', fontWeight: '500', padding: '7px 16px', borderRadius: t.radius.full, cursor: 'pointer', border: 'none', background: active ? t.colors.nav : 'transparent', color: active ? '#fff' : t.colors.textTertiary, fontFamily: t.fonts.sans }),
    ...
    btnGhost: { padding: '9px 18px', borderRadius: t.radius.full, border: `0.5px solid ${t.colors.border}`, background: t.colors.bgCard, color: t.colors.textSecondary, fontSize: '13px', fontWeight: '500', cursor: 'pointer', fontFamily: t.fonts.sans },
    btnSm: { padding: '5px 12px', borderRadius: t.radius.full, border: `0.5px solid ${t.colors.border}`, background: t.colors.bgCard, color: t.colors.textSecondary, fontSize: '11px', cursor: 'pointer', fontFamily: t.fonts.sans },
    btnDel: { padding: '5px 12px', borderRadius: t.radius.full, border: '0.5px solid #FEE2E2', background: '#FEF2F2', color: '#EF4444', fontSize: '11px', cursor: 'pointer', fontFamily: t.fonts.sans },
    formCard: { background: t.colors.bgCard, borderRadius: t.radius.lg, border: `1px solid ${t.colors.primary}`, padding: '20px', marginBottom: '16px' },
    card: { background: t.colors.bgCard, borderRadius: t.radius.lg, border: `0.5px solid ${t.colors.border}`, overflow: 'hidden' },
    ...
    <div style={s.page}>
      ...
      {activeTab === 'spotlight' && (
        <div>
          ...
          <div style={{ background: t.colors.bgCard, borderRadius: t.radius.lg, border: `0.5px solid ${t.colors.border}`, padding: '20px' }}>
            <div style={{ marginBottom: '12px' }}>
            ...
            <div style={{ marginBottom: '12px' }}>
              ...
              <input style={s.input} placeholder="e.g. Senior Creative Lead · 4 years" value={spotlightForm.role} onChange={e => setSpotlightForm({ ...spotlightForm, role: e.target.value })} />
            </div>
