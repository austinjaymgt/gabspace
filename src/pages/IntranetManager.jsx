...
export default function IntranetManager({ workspaceId, userRole }) {
  ...
  const s = {
    ...
    tabs: { display: 'flex', gap: '4px', marginBottom: '24px', background: t.colors.bgCard, borderRadius: '10px', padding: '4px', border: `0.5px solid ${t.colors.border}`, width: 'fit-content' },
    ...
    btnSm: { padding: '5px 12px', borderRadius: '6px', border: `0.5px solid ${t.colors.border}`, background: t.colors.bgCard, color: t.colors.textSecondary, fontSize: '11px', cursor: 'pointer', fontFamily: t.fonts.sans },
