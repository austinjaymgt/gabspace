...
const styles = {
  ...
  viewToggle: { display: 'flex', border: `1px solid ${t.colors.border}`, borderRadius: t.radius.full, overflow: 'hidden' },
  ...
  navBtn: { padding: '6px 12px', borderRadius: t.radius.full, border: `1px solid ${t.colors.border}`, backgroundColor: t.colors.bgCard, cursor: 'pointer', fontSize: t.fontSizes.md, color: t.colors.textSecondary, fontFamily: t.fonts.sans },
  ...
  editBtn: { padding: '6px 12px', borderRadius: t.radius.full, border: `1px solid ${t.colors.border}`, backgroundColor: t.colors.bgCard, color: t.colors.textSecondary, fontSize: t.fontSizes.sm, cursor: 'pointer', fontFamily: t.fonts.sans },
  ...
  mediaLink: { display: 'inline-block', padding: '8px 14px', borderRadius: t.radius.full, backgroundColor: t.colors.primaryLight, color: t.colors.primary, fontSize: t.fontSizes.base, fontWeight: '500', textDecoration: 'none' },
  deleteBtnFull: { padding: '10px', borderRadius: t.radius.full, border: 'none', backgroundColor: t.colors.dangerLight, color: t.colors.danger, fontSize: t.fontSizes.base, cursor: 'pointer', width: '100%', fontFamily: t.fonts.sans, fontWeight: '500' },
  table: { backgroundColor: t.colors.bgCard, borderRadius: t.radius.lg, border: `1px solid ${t.colors.border}`, overflow: 'hidden' },
  tableHeader: { display: 'grid', gridTemplateColumns: 'minmax(0, 2fr) minmax(0, 1fr) minmax(0, 1fr) minmax(0, 1fr) minmax(0, 1.5fr) minmax(0, 0.3fr)', padding: '12px 20px', backgroundColor: t.colors.bg, borderBottom: `1px solid ${t.colors.border}`, fontSize: t.fontSizes.xs, fontWeight: '600', color: t.colors.textTertiary, textTransform: 'uppercase', letterSpacing: '0.08em' },
  tableRow: { display: 'grid', gridTemplateColumns: 'minmax(0, 2fr) minmax(0, 1fr) minmax(0, 1fr) minmax(0, 1fr) minmax(0, 1.5fr) minmax(0, 0.3fr)', padding: '11px 20px', borderBottom: `1px solid ${t.colors.borderLight}`, alignItems: 'center', cursor: 'pointer' },
  itemTitle: { fontSize: t.fontSizes.sm, fontWeight: '500', color: t.colors.textPrimary },
  ...
  kanban: { display: 'grid', gridTemplateColumns: 'repeat(4, minmax(0, 1fr))', gap: '16px', alignItems: 'start' },
