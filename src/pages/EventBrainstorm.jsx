    ...
    <div style={{ padding: '32px', maxWidth: '860px' }}>
      ...
      <div style={{ marginBottom: '32px' }}>
        <div style={{ marginBottom: '14px' }}>
          <div style={{ fontSize: '15px', fontWeight: '600', color: t.colors.textPrimary }}>Saved Ideas</div>
          <div style={{ fontSize: '12px', color: t.colors.textTertiary, marginTop: '2px' }}>
            Edit ideas to add structure, or move one into projects or content
          </div>
        </div>
