...
const styles = {
  ...
  title: { fontSize: t.fontSizes['2xl'], fontWeight: '800', color: t.colors.textPrimary, margin: 0, fontFamily: t.fonts.heading, letterSpacing: '0.01em' },
  ...
  emptyTitle: { fontSize: t.fontSizes.lg, fontWeight: '600', color: t.colors.textPrimary, margin: '0 0 8px', fontFamily: t.fonts.sans },
  emptyText: { fontSize: t.fontSizes.base, color: t.colors.textTertiary, margin: '0 0 24px', textAlign: 'center', fontFamily: t.fonts.sans },
