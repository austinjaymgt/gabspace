    ...
    <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
      <div>
        ...
        <div style={{ fontSize: t.fontSizes.sm, color: t.colors.textTertiary, marginBottom: '10px', maxWidth: '520px' }}>
          In Claude, go to Settings → Connectors → Add custom connector and paste this URL. Claude can then read your businesses — clients, projects, tasks, invoices and more — and, when you ask, create tasks, draft invoices and add to your content calendar. Name a business to point it there; otherwise it uses your active one.
        </div>
